...
public class GenerarHTMLLogin extends GenerarHTMLGeneral {
    public GenerarHTMLLogin(){}
    ...
    public String generarHTMLMain_content(HttpServletRequest request,String a){
        ...
        html+=              "<div class=\"box_title\"><span>Admin</span> Login</div>\n";
        html+=                  "<div class=\"form\">\n";
        html+=                      "<form name=\"login\" method=\"post\" action= \"LoginCheck.jsp\">\n";                 
     ...
     // html+=      "<a href=\"javascript:alert('Ponte en contacto con el administrador del sistema');\" style=\"text-decoration:none\">¿Has olvidado tu contraseña?</a></p></span>";
        html+=    "</div>\n";
        html+=  "</div>\n";
        html+="</div>\n";
        return html;
